...
- ZooKeeper = teacher
- The teacher: Takes attendance (which students are present).
...
🚀 What’s Changing Now
========================
Newer versions of Kafka don’t need ZooKeeper anymore. Instead, Kafka has its own built-in system called KRaft mode. 
This makes things simpler because you don’t need a separate “teacher” — the students (Kafka brokers) can organize themselves.
